...
var chargeRider = require('./controllers/chargeRider');
var interacHistory = require('./controllers/interacHistory');
...
app.use('/chargeRider', chargeRider);
app.use('/interacHistory', interacHistory);
//Host the app
